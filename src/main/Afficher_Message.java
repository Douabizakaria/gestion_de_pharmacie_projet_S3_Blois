...
public class Afficher_Message extends javax.swing.JFrame {

    
    public Afficher_Message() {
        initComponents();
        message_De.setText(Pharmacie.à);
        message_text.setText(Pharmacie.texte);
    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(560, 382));
...
new Envoyer_Message().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Afficher_Message.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
