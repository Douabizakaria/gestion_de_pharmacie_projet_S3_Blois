...
public class Boite_de_reception extends javax.swing.JFrame {
Connection con = null;
PreparedStatement pre= null;
ResultSet res = null;
ArrayList<String> arr ;    
    public Boite_de_reception() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("formulaire de boîte de réception");
        ...
        Nom_utilisateur.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nom_utlisateur :" }));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "   Message de", "   Message vers", "   Message_Text"
            }
        ) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Nom_utilisateur, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2.setBounds(10, 88, 656, 338);

        jLabel2.setBackground(new java.awt.Color(153, 255, 153));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/1621379.jpg"))); // NOI18N
        getContentPane().add(jLabel2);
        jLabel2.setBounds(0, 70, 730, 420);
    ...
    private void Nom_utilisateurItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_Nom_utilisateurItemStateChanged
      ...
      String sql = " select * from inbox where (MESSAGE_A= '"+Pharmacie.Nom_utilisateur1.getText()+"' and MESSAGE_DE='"+Nom_utilisateur.getSelectedItem()+"') or (MESSAGE_A= '"+Nom_utilisateur.getSelectedItem()+"' and MESSAGE_DE='"+Pharmacie.Nom_utilisateur1.getText()+"') ";
 try {
...
new Envoyer_Message().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Boite_de_reception.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
